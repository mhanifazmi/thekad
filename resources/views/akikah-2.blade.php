    ...
    <div class="wedding-card">
        ...
        <section class="event-info">
            <div class="wrapper">
                ...
                <p class="greeting">Dengan rendah hati, kami sekeluarga menjemput tuan/puan sekeluarga hadir ke majlis
                    Akikah dan doa selamat yang akan diadakan seperti berikut :
                </p>
