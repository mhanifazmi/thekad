...
<head>
    <title>Doa Selamat Menunaikan Umrah&nbsp;| A Wedding Invitation</title>
    <meta charset="utf-8" />
    <meta name="viewport" id="vp">
    <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport" />
    <meta content="production" name="environment" />
    <meta content="Doa Selamat Menunaikan Umrah&nbsp;| A Wedding Invitation" property="og:title" />
...
<body class="application designs preview" style="color: #5c6274">
    <div class="wedding-card">
        <section class="hero"
            style="background-image: url('images/faiz/bg.png'); background-repeat: no-repeat; background-position: center top; background-size: 100% auto;">
            <div class="wrapper">
                <div class="animate__animated animate__slideInDown animate__slow walimatul"
                    ...
                    <img style="width: 100%;" src="{{ asset('images/bismillah-2.png') }}" />
                    <p style="margin-top: 10px !important">Jemputan Ke Majlis Doa Selamat</p>
                </div>
                <div class="wedding-couple" style="color: #5c6274;">
                    <p style="text-transform: capitalize;" class="groom animate__animated animate__slideInLeft animate__slow">{{ $card->info->bride }}
                    </p>
                    <p class="with animate__animated animate__bounceIn animate__slower">&amp;</p>
                    <p style="text-transform: capitalize;"
                        class="bride animate__animated animate__slideInRight animate__slow">{{ $card->info->bride_partner }}
                    </p>
                </div>
        ...
        <section class="event-info">
            <div class="wrapper">
                ...
                <p class="greeting">Dengan segala hormatnya mempersilakan tuan/puan ke Majlis Doa Selamat keberangkatan</p>
                <div class="wedding-people">
                    <p>{{ $card->info->bride }}</p>
                    <p>&</p>
                    <p>{{ $card->info->bride_partner }}</p>
                </div>
                <p class="greeting">ke tanah suci(Umrah). Kehadiran tuan/puan amat kami hargai.</p>
        ...
        <section class="countdown"
            style="background-image: url('images/faiz/small-section.png'); background-repeat: no-repeat; background-position: center; background-size: 100% 100%;">
            <div class="wrapper" style=" margin-top: 30px;">
                ...
                <div class="firman-container">
                    <p class="firman">
                        "Ibadah umrah ke umrah lainnya akan menghapuskan dosa-dosa yang ada antara keduanya-duanya."
                    </p>
                    <p class="firman-ayat">
            ...
            <div class="wrapper">
                <div class="doa">
                    <p style="text-align: justify; text-justify: inter-word;">
                        Ya Allah, dengan hati yang penuh khusyu’ dan tawadu’, kami bersyukur kepada-Mu kerana dengan keizinan dan kurniaan-Mu maka dapatlah kami berhimpun sempena keberangkatan <b>Encik Ahaddin bin Diran</b> bersama <b>Puan Rukenah binti Paijo</b>, yang akan berangkat menunaikan ibadah umrah/haji pada hari yang mulia ini, diserikan dengan hamparan petunjuk, keredhaan dan keberkatan daripada-Mu ya Allah.
                        <br>
                        <br>
                        Ya Allah, berikanlah keselamatan dan perlindungan kepada mereka semasa pergi dan kembali daripada menunaikan ibadah umrah/haji ini, juga keselamatan buat anak-anak serta harta benda yang ditinggalkan. Jauhkanlah mereka dari perasaan resah gelisah, gangguan kesihatan dan tidak selesa. Kukuhkanlah keimanan dan keyakinan serta peliharalah mereka dengan dipermudahkanlah segala urusan, keselamatan zahir dan batin, harta benda serta keamanan di sepanjang perjalanan untuk menuju ke rumah-Mu, Baitullahil Haram serta mengunjungi ziarah makam nabi kami, Muhammad S.A.W.
                        <br>
                        <br>
                        Kami juga memohon, peliharalah mereka dari segala mara bahaya, penyakit dan perasaan duka. Kurniakanlah kepada mereka umrah/haji yang mabrur. Amalan-amalan yang diterima, ziarah yang aman, doa-doa yang dimakbulkan serta dosa-dosa yang diampunkan.
                    </p>
    ...
    <script>
        ...
        var event_name = 'Majlis Doa Selamat Encik Ahaddin dan Puan Rukenah'
        var event_title = 'Majlis Doa Selamat'
    </script>
